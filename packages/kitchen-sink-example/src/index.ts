...
(async function loadScene() {
  ...
  const alphaBlendModeTestGltf = await loadGLTF(
    "https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Models/2.0/AlphaBlendModeTest/glTF-Binary/AlphaBlendModeTest.glb"
  );
  const boxAnimatedGltf = await loadGLTF("https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Models/2.0/BoxAnimated/glTF-Binary/BoxAnimated.glb");
  const boxInterleavedGltf = await loadGLTF("https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Models/2.0/BoxInterleaved/glTF-Binary/BoxInterleaved.glb");
  const boxTexturedNonPowerOfTwoGltf = await loadGLTF(
    "https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Models/2.0/BoxTexturedNonPowerOfTwo/glTF-Binary/BoxTexturedNonPowerOfTwo.glb"
  );
  const metalRoughSpheresGltf = await loadGLTF(
    "https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Models/2.0/MetalRoughSpheres/glTF-Binary/MetalRoughSpheres.glb"
  );
  const normalTangentTestGltf = await loadGLTF(
    "https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Models/2.0/NormalTangentTest/glTF-Binary/NormalTangentTest.glb"
  );
  const normalTangentMirrorTestGltf = await loadGLTF(
    "https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Models/2.0/NormalTangentMirrorTest/glTF-Binary/NormalTangentMirrorTest.glb"
  );
  const riggedSimpleGltf = await loadGLTF("https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Models/2.0/RiggedSimple/glTF-Binary/RiggedSimple.glb");
  const textureCoordinateTestGltf = await loadGLTF(
    "https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Models/2.0/TextureCoordinateTest/glTF-Binary/TextureCoordinateTest.glb"
  );
  const textureSettingsTestGltf = await loadGLTF(
    "https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Models/2.0/TextureSettingsTest/glTF-Binary/TextureSettingsTest.glb"
  );
  const vertexColorTestGltf = await loadGLTF("https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Models/2.0/VertexColorTest/glTF-Binary/VertexColorTest.glb");
  ...
  particleEmitter = new ParticleEmitter(firefoxLogoTexture)
